...
class TestPlaceDetail(TestCase):
    ...
    def test_modify_someone_else_place_details_not_authorized(self):
        response = self.client.post(reverse('place_infos', kwargs={'place_pk':5}), {'notes':'awesome'}, follow=True)
        self.assertEqual(403, response.status_code)   # 403 Forbidden 
    ...
    def test_place_detail(self):
        ...
        response = self.client.get(reverse('place_infos', kwargs={'place_pk':1} ))
        # Check correct template was used
        self.assertTemplateUsed(response, 'travel_wishlist/place_info.html')
    ...
    def test_modify_notes(self):
        ...
        response = self.client.post(reverse('place_infos', kwargs={'place_pk':1}), {'notes':'awesome'}, follow=True)
    ...
    def test_add_notes(self):
        ...
        response = self.client.post(reverse('place_infos', kwargs={'place_pk':4}), {'notes':'yay'}, follow=True)
    ...
    def test_add_date_visited(self):
        ...
        response = self.client.post(reverse('place_infos', kwargs={'place_pk':4}), {'date_visited': date_visited}, follow=True)
    ...
    def test_upload_new_image_for_own_place(self):
        ...
        with self.settings(MEDIA_ROOT=self.MEDIA_ROOT):
            ...
            with open(img_file_path, 'rb') as img_file:
                resp = self.client.post(reverse('place_infos', kwargs={'place_pk': 1} ), {'photo': img_file }, follow=True)
    ...
    def test_change_image_for_own_place_expect_old_deleted(self):
        ...
        with self.settings(MEDIA_ROOT=self.MEDIA_ROOT):
            ...
            with open(first_img_file_path, 'rb') as first_img_file:
                ...
                resp = self.client.post(reverse('place_infos', kwargs={'place_pk': 1} ), {'photo': first_img_file }, follow=True)
                ...
                with open(second_img_file_path, 'rb') as second_img_file:
                    resp = self.client.post(reverse('place_infos', kwargs={'place_pk':1}), {'photo': second_img_file}, follow=True)
    ...
    def test_upload_image_for_someone_else_place(self):
        ...
        with self.settings(MEDIA_ROOT=self.MEDIA_ROOT):
            ...
            with open(img_file, 'rb') as image:
                resp = self.client.post(reverse('place_infos', kwargs={'place_pk': 5} ), {'photo': image }, follow=True)
